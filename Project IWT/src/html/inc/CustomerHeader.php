...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<header>	
		<div>
		<!-- Add Logo -->
			<a href="HomeMyUserLog1.php">
			<img class="floatLogo" src="../images/logo.png" alt="Enjoy Safari logo" width="100" height="100"></a>
			<a href="HomeMyUserLog1.php"><h1 class="floatWebName">Enjoy Safari</h1></a>>
		<!-- Add Social Media -->
		...
		<!-- Login area -->
			<div class="userIcon1">
				<a href = "user_customer.php">
				<img class="imgAdmin" src="../images/girl.jfif" alt="SingIn" width="70" height="70"></a>
			</div>
		...
		<div class="menuH" >
			...
			<a class="menu" href = "HomeMyUserLog1.php"> Home </a> 
			...
			<a class="menu" href = "ContacUsLog1.php"> Contact Us </a>
	...
	<div class="userHeader">
		<div class="nameAp"> <h2>Customer Page </h2></div>
		
		<div class="userName"> Welcome <?php echo " " . $_SESSION['f_name'] . " " . $_SESSION['l_name']; ?> 
