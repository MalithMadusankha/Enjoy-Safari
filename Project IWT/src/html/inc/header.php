  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<header>	
		...
		<!-- Add Logo -->
			...
			<a href="HomeMy.php"><h1 class="floatWebName">Enjoy Safari</h1></a>>
		<!-- Add Social Media -->
		...
		<!-- Login area -->
			<div class="userIcon1">
				<a href = "SignIn.php">
				<img  src="../images/SignIn.png" alt="SingIn" width="50" height="50"><br>SingIn</a>
				<!-- <a href = "SignIn.html"> -->
				<!-- <h5 class=""> SingIn </h5></a> -->
			</div>
			<div class="userIcon2">
				<a href = "SignUp.php">
				<img  src="../images/signUp.webp" alt="singnUp" width="50" height="50"><br>SingUp</a>
				<!-- <a href = "SignUp.html">
		...
		<div class="menuH" >
			...
			<a class="menu" href = "HomeMy.php"> Home </a> 
			...
			<a class="menu" href = "ContacUs.php"> Contact Us </a>
